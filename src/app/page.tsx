...
export default function Home() {
  return (
    <div className="bg-gray-100">
      ...
      {/* CTA Section */}
      <section className="bg-gray-800 p-8 md:p-12 text-center mt-12 md:mt-16">
        ...
        <Link
          href="/contact"
          className="inline-block bg-white text-gray-800 px-6 md:px-8 py-2 md:py-3 rounded-lg font-semibold hover:bg-gray-50 transition-colors"
        >
          Contact Us
        </Link>
      </section>
